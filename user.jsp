...
<div id="carousel-example-generic" class="carousel slide container-fluid" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
     ...
     <div class="item">
      <img src="images/avengersendgame.jpg" alt="..." style="width:800px;height:500px;">
      <div class="carousel-caption">
      <b>Movie 4</b>
      </div>
    </div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <%
                ...
                Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "HR", "giri263140");
                Statement stmt = null;
